<?php 
  ...
  if ($_SERVER['REQUEST_METHOD'] == "POST" && $_POST['login'] == "login") {
    ...
    if (empty($email)) {
      ...
      $login_error['email'] = "<div class='text-danger'><small>Invalid Email Address</small></div>";
    ...
    if (count($login_error) == 0) {
      ...
      $output = $userauth->patientLogin($email, $password);
    }
              ...
              <div class="login-wrapper">
                  <form action="" method="post">
                    <div class="text-center mb-4">
                      ...
                      <h3 class="mb-3 font-weight-normal">Patient Sign in</h3>
                      <?php 
                        if (isset($output)) {
                   ...
                   <div class="text-center">
                      ...
                      <p class="">Don't have an account? <a href="patientregister.php" class="">Register here</a></p>            
                  </div> 
              </div>
            </div>
          </div>
